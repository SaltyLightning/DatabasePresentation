...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-light bg-light static-top">
      <div class="container">
        <a class="navbar-brand" href="#">Overstatted</a>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-9 mx-auto">
            <h1 class="mb-5">Leverage the power of our analytics</h1>
          </div>
          <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
            <form action="submit.php" method="post">
              <div class="form-row">
                <div class="col-12 col-md-9 mb-2 mb-md-0">
                  <input type="text" name="name" class="form-control form-control-lg" placeholder="Enter your Battletag...">
                </div>
                <div class="col-12 col-md-3">
                  <button type="submit" class="btn btn-block btn-lg btn-primary">Power up!</button>
                </div>
              </div>
            </form>
          </div>
